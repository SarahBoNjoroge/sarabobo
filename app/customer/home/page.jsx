    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans flex">
      ...
      <div className="flex-1">
        ...
        <section className="py-16 px-6 max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-purple-800 mb-4">About Brightmind books</h2>
          <p className="text-lg text-gray-700">
            Brightmind books is your gateway to academic excellence. We provide a curated selection of textbooks, novels, and professional guides alongside essential stationery. Our mission is to empower learners and lifelong readers across the globe.
          </p>
        </section>
        ...
        <section className="py-16 px-6 text-center max-w-4xl mx-auto">
          ...
          <p className="text-gray-700">📧 Email: support@Brightmind booksbooks.co.ke</p>
