...
export default function AdminStationeryPage() {
  ...
  const fetchStationery = async () => {
    try {
      const res = await fetch('https://tender-empathy-production-c8ad.up.railway.app/api/admin/index.php');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEditing
        ? 'https://tender-empathy-production-c8ad.up.railway.app/api/admin/update_stationery.php'
        : 'https://tender-empathy-production-c8ad.up.railway.app/api/admin/add_stationery.php';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://tender-empathy-production-c8ad.up.railway.app/api/admin/delete_stationery.php?id=${id}`);
      const data = await res.json();
      if (data.success) {
